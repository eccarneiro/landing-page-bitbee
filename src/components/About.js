...
const About = () => {
    return (
        <>
        <div>
            <h1 id='about' className="text-center mt-32 font-semibold lg:text-4xl  text-black mb-6">SOBRE NÓS </h1>
        </div>
        <div 
        ...
        >    
            <div className="relative z-10 flex flex-wrap justify-center lg:grid lg:grid-cols-3 gap-8 px-4 py-8 ">
                ...
                <div className="rounded-3xl shadow-2xl bg-bit-bee-yellow p-8 ring-1 ring-gray-900/10 sm:mx-8 sm:rounded-md sm:p-10 lg:mx-0 lg:rounded-3xl transition-all duration-300 hover:scale-105 h-64 flex flex-col justify-between">
                    <h3 className="flex justify-center text-3xl font-semibold text-black">Profissionalismo</h3>
                ...
                <div className="rounded-3xl shadow-2xl bg-bit-bee-yellow p-8 ring-1 ring-gray-900/10 sm:mx-8 sm:rounded-md sm:p-10 lg:mx-0 lg:rounded-3xl transition-all duration-300 hover:scale-105 h-64 flex flex-col justify-between">
                    <h3 className="flex justify-center text-3xl font-semibold text-black">Inovação</h3>
                ...
                <div className="rounded-3xl shadow-2xl bg-bit-bee-yellow p-8 ring-1 ring-gray-900/10 sm:mx-8 sm:rounded-md sm:p-10 lg:mx-0 lg:rounded-3xl transition-all duration-300 hover:scale-105 h-64 flex flex-col justify-between">
                    <h3 className="flex justify-center text-3xl font-semibold text-black">Comprometimento</h3>
