            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap justify-between items-center">
                    <div className="w-full md:w-1/3 mb-6 md:mb-0">
                        <h3 className="text-2xl font-bold text-bit-bee-yellow mb-2">BitBee</h3>
                        <p className="text-sm">Transformando ideias em soluções digitais inovadoras</p>
                    </div>
                    <div className="w-full md:w-1/3 mb-6 md:mb-0">
                        <h4 className="text-lg font-semibold text-bit-bee-yellow mb-2">Contato</h4>
                        <p className="text-sm">Email: contato@bitbee.com</p>
                        <p className="text-sm">Telefone: (11) 1234-5678</p>
                    </div>
                    <div className="w-full md:w-1/3">
                        <h4 className="text-lg font-semibold text-bit-bee-yellow mb-2">Redes Sociais</h4>
